...
Country_happy2 <- merge(Country_happy, percievedcorruption)
...
model11 <- randomForest(HappinessScore ~ .-HappinessScore, data = num_happy, importance = TRUE)
model11
plot(model11)
...
>>>>>>> ab458cd7889ae5a98b550c3974e8edecd81e5c31
