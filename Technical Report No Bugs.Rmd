...
rf <- randomForest(HappinessScore ~ .-HappinessScore, data = num_happy, importance = TRUE)
rf
plot(rf)
predictrf <- predict(rf, num_happy, type = "response")
predictrf
MSErf<- mean((predictrf - num_happy$HappinessScore)^2)
MSErf
```
>>>>>>> 9295f90abf23b64023815594482bcb307cf14666
